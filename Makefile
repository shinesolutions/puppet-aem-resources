...
test-integration:
	...
	for test in aem_author_remove_default_agents aem_publish_remove_default_agents aem_author_standby_set_config aem_create_system_users aem_author_dispatcher_set_config aem_publish_dispatcher_set_config; do \
